...
"[project]/app/ItemList.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ItemList = ()=>{
    ...
    const { authFetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ItemList.useEffect": ()=>{
            const fetchItems = {
                "ItemList.useEffect.fetchItems": async ()=>{
                    setIsLoading(true);
                    try {
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ItemList.useMemo[categories]": ()=>{
            if (!items) return [
                'all'
            ];
            const allCategories = items.map({
                "ItemList.useMemo[categories].allCategories": (item)=>item.category
            }["ItemList.useMemo[categories].allCategories"]);
            return [
                'all',
    ...
    const filteredItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ItemList.useMemo[filteredItems]": ()=>{
            if (!items) return [];
            return items.filter({
                "ItemList.useMemo[filteredItems]": (item)=>{
    ...
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "טוען פריטים..."
        }, void 0, false, {
            fileName: "[project]/app/ItemList.tsx",
            lineNumber: 49,
            columnNumber: 16
        }, ("TURBOPACK compile-time value", void 0));
    }
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: categories.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                value: cat,
                                children: cat === 'all' ? 'כל הקטגוריות' : cat
                            }, cat, false, {
                                fileName: "[project]/app/ItemList.tsx",
                                lineNumber: 70,
                                columnNumber: 25
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: filteredItems.length > 0 ? filteredItems.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ItemCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    className: "text-center text-gray-500 col-span-full",
                    children: "לא נמצאו פריטים התואמים את החיפוש."
                }, void 0, false, {
                    fileName: "[project]/app/ItemList.tsx",
                    lineNumber: 80,
                    columnNumber: 22
...
_s(ItemList, "7+S1/usf6QLbd5+xxR18CvnpjtU=", false, function() {
    return [
...
//# sourceMappingURL=_06fe8834._.js.map